export default [
    {
        ...
        `Automated 50+ API endpoint tests in Postman using JavaScript`,
        `Optimized 10+ API endpoints by reducing the number of times they called the database, resulting in a 5-10x
        faster response times`,
        `Refactored 50+ service methods to reduce their cognitive complexity and make the code more maintainable`,
        `Integrated SonarQube into the team's main CI/CD pipeline on Azure DevOps, having an enormous impact
        on the team's ability to manage the security and maintainability of the C#.NET code`]
    },
    {
        title: 'Velan Inc.',
